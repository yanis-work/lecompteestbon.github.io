...
######################################################################################################
Fonction aide():
    # Boite de dialogue pour afficher les rÃƒÂ¨gles du jeu
...
Fonction egal():
        ...
        Calcul les nombres entrÃƒÂ©e et le rÃƒÂ©sultat et revoi le resultat totlal dans le label (Label Resultat )

######################################################################################################
Fonction game(resultat):

        Compare le nombre gÃƒÂ©nerer et le nombre calculÃƒÂ©

                si le nombre gÃƒÂ©nÃƒÂ©rÃƒÂ© == nombre calculÃƒÂ©
                    # Appel la fonction Message => Le jeu est gagnÃƒÂ©
                Sinon
...
nbrTentative => Nombre de Tentative Restant initialiser a 10
                ArrivÃƒÂ© a 0 -> Le jeu est arrete

nbrgenerer => Nombre AlÃƒÂ©atoire gÃƒÂ©nÃƒÂ©rer entre 1 et 999 au commencement de chaque partie
...
def game(resultat):
    ...
    if resultat == nbrgenerer:
        Message("GagnÃƒÂ©", "Vous avez gagnÃƒÂ© \n Voulez vous recommencer")
    else:
        nbrTentative -= 1
        LblNbrTentative["text"] = "Nombre de tentative restant : " + str(nbrTentative)
